    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=200, validators=[django.core.validators.RegexValidator(code='invalid_text', message='The text must start with, and end with, a alphanumeric character. There should NOT be any consecutive spaces too.', regex='^([a-zA-Z0-9]+\\s)*[a-zA-Z0-9]+$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(max_length=50, validators=[django.core.validators.RegexValidator(code='invalid_text', message='The text must start with, and end with, a alphanumeric character. There should NOT be any consecutive spaces too.', regex='^([a-zA-Z0-9]+\\s)*[a-zA-Z0-9]+$')])),
                ('year', models.DecimalField(decimal_places=0, max_digits=4, validators=[django.core.validators.MinValueValidator(2016)])),
                ('deviceTag', inventoryManagement.models.UpperCaseCharField(max_length=50, unique=True, validators=[django.core.validators.RegexValidator(code='invalid_deviceTag', message='The device tag MUST follow the pattern <location_firstLetter>-<department>-<deviceShortName>-<intergerNumber>', regex='^([a-zA-z])(-)((?:[a-zA-Z][a-zA-Z]+))(-)((?:[a-zA-Z][a-zA-Z]+))(-)(\\d+)$')])),
